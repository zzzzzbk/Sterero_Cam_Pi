...
class DPT_DINOv2(nn.Module):
    def __init__(self, encoder='vitl', features=256, out_channels=[256, 512, 1024, 1024], use_bn=False, use_clstoken=False, pretrained_dino=False):
        ...
        # Load DINOv2 from the local dinov2 folder bundled in this repo
        _dinov2_local = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), 'dinov2')
        self.pretrained = torch.hub.load(_dinov2_local, 'dinov2_{:}14'.format(encoder), source='local', pretrained=pretrained_dino)
